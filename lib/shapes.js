...
class Triangle extends Shape {
    ...
    render() {
        ...
        const txt = `<text x="${Shape.imageWidth / 2}" y="${Shape.imageHeight -  Math.round(Shape.imageHeight / 3)}" text-anchor="middle" alignment-baseline="middle" fill="${this.textColor}" font-size="${fontSize - (fontSize / 4)}">${this.text}</text>`;
